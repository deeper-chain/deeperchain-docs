        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center">
          <div className="lg:w-1/2">
            <div className="font-title text-5xl lg:text-6xl font-extrabold mb-8">
              DeeperChain <br /> Rust Docs
            </div>
            <p className="max-w-lg">
              DeeperChain uses Rust&apos;s source code documentation and crate
            ...
            <ul className="list-inside mdx-anchor text-substrateBlue dark:text-substrateBlue-light">
              <li>
                <Link to="https://doc.rust-lang.org/rust-by-example/meta/doc.html">
                  Master
                </Link>
              </li>
              <li>
                <Link to="https://rustcrustc.github.io/rustc-dev-guide-zh/about.html">
                  Monthly-2021-09+1
                </Link>
                {` `}
                <Link to="https://paritytech.github.io/substrate/">
                  {`(latest)`}
                </Link>
              </li>
              {/* <li>
